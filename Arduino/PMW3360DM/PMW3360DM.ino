...
#define Motion_Interrupt_Pin 21
...
void setup() {
  ...
  enableInterrupt(Motion_Interrupt_Pin, UpdatePointer, FALLING);
...
void adns_write_reg(byte reg_addr, byte data){
  ...
  delayMicroseconds(15); // tSCLK-NCS for write operation
  adns_com_end();
  delayMicroseconds(80); // tSWW/tSWR (=120us) minus tSCLK-NCS. Could be shortened, but is looks like a safe lower bound 
}
